...
let detector = new PIR.MotionDetector({
 ...
 * @returns void
 */
PIRSensor.prototype.reset = function(options) {
 ...
 * @returns void
 */
PIRSensor.prototype.clearStablizer = function() {
 ...
 * @returns bool
 */
PIRSensor.prototype.transitionToMotion = function(now, motionDetected) {
...
exports.MotionDetector = PIRSensor;
